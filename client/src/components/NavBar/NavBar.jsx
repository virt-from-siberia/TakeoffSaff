    ...
    <div className='navBar'>
      ...
      <div className='navBar__handler'>
        <div className='navBar__handler-inputBlock'>
          {serachPanel ? (
            <>
              <div className='add-contact' onClick={createHandler}>
                <PersonAddIcon />
                <p>Создать контакт</p>
              </div>
              ...
              <input
                type='text'
                onChange={(evt) => onSearchHandler(evt.target.value)}
                value={inputValue}
              />
            </>
          ) : null}
        ...
        <div className='navBar__handler-out'>
          <ExitToAppOutlinedIcon className='exit' onClick={logoutHandler} />
        </div>
      </div>
    </div>
  );
